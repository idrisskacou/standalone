...
// node_modules/@astrouxds/astro-web-components/dist/esm/rux-timeline.entry.js
...
var RuxTimeline = class {
  ...
  get pxToTimeRatio() {
    if (this.interval === "hour") {
      return this.columnWidth / 60;
    }
    if (this.interval === "minute") {
      return this.columnWidth / 1;
    }
    if (this.interval === "day") {
      return this.columnWidth / 24;
    }
    return 2;
  }
  ...
  _calculatePlayheadFromTime(time) {
    if (new Date(time) < new Date(this.start) || new Date(time) > new Date(this.end)) {
  ...
  _updateRegions() {
    ...
    if (slot) {
      const tracks = [...slot === null || slot === void 0 ? void 0 : slot.assignedElements({
        flatten: true
      }).filter((node) => node.tagName.toLowerCase() === "rux-track")];
      tracks.map((el) => {
        el.width = this.width;
        el.columns = this.columns;
        if (this.hasPlayedIndicator) {
    ...
    const rulerTrack = rulerSlot === null || rulerSlot === void 0 ? void 0 : rulerSlot.assignedElements({
      flatten: true
    }).find((el) => el.tagName.toLowerCase() === "rux-track");
    if (rulerTrack) {
  ...
  _handleScroll() {
    var _a, _b;
    const scrollOffset = this.timelineContainer ? (_a = this.timelineContainer) === null || _a === void 0 ? void 0 : _a.scrollTop : 0;
    this.playheadHeight = scrollOffset;
    const leftOffset = this.timelineContainer ? (_b = this.timelineContainer) === null || _b === void 0 ? void 0 : _b.scrollLeft : 0;
  ...
  static get watchers() {
    return {
      "hasPlayedIndicator": ["syncPlayhead"],
      "playhead": ["syncPlayhead"],
      "zoom": ["handleZoomChange"],
      "start": ["handleChange"],
      "end": ["handleChange"],
      "interval": ["handleChange"],
      "timezone": ["handleChange"]
    };
  }
};
RuxTimeline.style = ruxTimelineCss;
export {
  RuxTimeline as rux_timeline
};
//# sourceMappingURL=rux-timeline.entry-EWGF4CHY.js.map
