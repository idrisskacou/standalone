...
var RuxMonitoringProgressIcon = class {
  ...
  render() {
    return h("div", {
      ...
      class: "rux-advanced-status__icon-group",
      part: "icon-group"
    }, h("rux-status", {
      status: this._status,
      part: "status-icon"
    ...
    }, Math.ceil((this.progress - this.min) / (this.max - this.min) * 100), "%"), h(MonitoringBadge, {
...
export {
  RuxMonitoringProgressIcon as rux_monitoring_progress_icon
};
//# sourceMappingURL=rux-monitoring-progress-icon.entry-NDJYEQO2.js.map
