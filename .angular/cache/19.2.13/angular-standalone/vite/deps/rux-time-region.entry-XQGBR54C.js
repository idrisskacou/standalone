...
var RuxTimeRegion = class {
  ...
  get formattedTime() {
    ...
    try {
      return formatInTimeZone(new Date(this.start), this.timezone, "HH:mm") + " - " + formatInTimeZone(new Date(this.end), this.timezone, "HH:mm");
    } catch (e) {
      return false;
    }
  }
  render() {
    return h(Host, null, h("div", {
      ...
      class: {
        ...
        "rux-time-region--partial-start": this.partial === "start" || this.partial === "ongoing",
        "rux-time-region--partial-end": this.partial === "end" || this.partial === "ongoing"
      }
    }, h("div", {
      class: "rux-time-region__content"
    }, this.status ? h("rux-status", {
      class: {
        "light-theme": this.selected
      },
      status: this.status
    }) : null, h("slot", null)), !this.hideTimestamp ? h("div", {
...
export {
  RuxTimeRegion as rux_time_region
};
//# sourceMappingURL=rux-time-region.entry-XQGBR54C.js.map
