...
// node_modules/@astrouxds/astro-web-components/dist/esm/rux-global-status-bar.entry.js
var AppMeta = ({
  domain,
  name,
  version
...
var RuxGlobalStatusBar = class {
  constructor(hostRef) {
    ...
    this.username = "";
    this.appDomain = void 0;
    this.appName = void 0;
    this.appVersion = void 0;
    this.menuIcon = "apps";
  }
  render() {
    return h(Host, null, h("header", {
      part: "container"
    }, h("slot", {
      name: "left-side"
    }, this.includeIcon && h("rux-icon", {
      icon: `${this.menuIcon}`,
      size: "small",
      class: this.appState || this.username ? "shifted-up" : "",
      exportparts: "icon"
    })), h("slot", {
      name: "app-meta"
    }, (this.appDomain || this.appName || this.appVersion) && h(AppMeta, {
      domain: this.appDomain,
      name: this.appName,
      version: this.appVersion
    }, h("div", {
      class: "app-state-wrapper"
    }, this.appState && h("div", {
      class: `app-state ${this.appStateColor}`,
      part: "app-state"
    }, this.appState), this.username && h("div", {
      class: "username",
      part: "username"
    }, this.username)))), h("div", {
...
export {
  RuxGlobalStatusBar as rux_global_status_bar
};
//# sourceMappingURL=rux-global-status-bar.entry-AG2IM5QH.js.map
