...
var RuxMonitoringIcon = class {
  ...
  render() {
    return h("div", {
      ...
      class: "rux-advanced-status__status"
    }, h("rux-status", {
      status: this.status,
      part: "status-icon"
    })), h("rux-icon", {
...
export {
  RuxMonitoringIcon as rux_monitoring_icon
};
//# sourceMappingURL=rux-monitoring-icon.entry-ZKVYYPRO.js.map
